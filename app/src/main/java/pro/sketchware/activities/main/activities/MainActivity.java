...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding.bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.item_projects) {
                ...
                return true;
            } else if (id == R.id.item_swbhub) {
                navigateToProjectsStoreFragment();
                return true;
            }
            return false;
        });
    ...
    private Fragment getFragmentForNavId(int navItemId) {
        ...
        } else if (navItemId == R.id.item_swbhub) {
    ...
    private void navigateToProjectsStoreFragment() {
        ...
        currentNavItemId = R.id.item_swbhub;
    }
